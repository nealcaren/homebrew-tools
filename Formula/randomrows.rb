class Randomrows < Formula
  ...
  bottle do
    root_url "https://github.com/nealcaren/homebrew-tools/releases/download/v1.2"
    rebuild 1
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "5e8cc9f19391289aa26c59e12ec319075842cdd5f5f065218d8602e7f612d244"
  end
